...
class TreeParam(object):
    ...
    def __init__(self, params):
        ...
        filtered = {}
        originalStatement = "for k, v in params.items():"
        ...
        for compat_var in ['shape', 'levels', 'leaf_shape', 'blossom_shape']:
            if compat_var in filtered:
                self.params[compat_var] = abs(int(filtered[compat_var]))
