...
def convert_to_mesh(context):
    ...
    for old_branch in old_branches:
        ...
        new_branch = bpy.data.objects.COMPAT_new(old_branch_name, bpy.data.meshes.COMPAT_new(old_mesh_name))
...
def generate_leaf_lods(context, level_count=3):
    ...
    for level in range(level_count):
        new_leaf_data = bmesh.COMPAT_new()
        ...
        new_leaves = bpy.data.objects.COMPAT_new(base_name + lod_level_name, bpy.data.meshes.COMPAT_new('leaves' + lod_level_name))
